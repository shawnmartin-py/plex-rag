...
def test_recommend_with_no_history_skips_rewriter(single_doc: Document) -> None:
...
def test_recommend_with_history_calls_rewriter(single_doc: Document) -> None:
...
def test_recommend_merges_multiple_retrievers() -> None:
...
def test_recommend_all_sections_for_same_movie_reach_generator() -> None:
    synopsis = make_doc("tt001", "Parasite", "synopsis")
    craft = make_doc("tt001", "Parasite", "enriched", "craft")
    meaning = make_doc("tt001", "Parasite", "enriched", "meaning")
...
def test_recommend_passes_original_question_to_generator(single_doc: Document) -> None:
    generator = MagicMock(spec=RecommendationGenerator)
    generator.generate.return_value = "answer"
    recommender = MovieRecommender(
...
def test_recommend_returns_generator_output(single_doc: Document) -> None:
    generator = MagicMock(spec=RecommendationGenerator)
