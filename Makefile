...
eval-faithfulness: ## Run the RAGAS faithfulness eval against the golden dataset (needs GOOGLE_API_KEY, makes real Gemini calls, not part of `make check`/CI — see evals/README.md)
