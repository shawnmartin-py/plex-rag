...
def _media_item_from_metadata(metadata: dict) -> MediaItem:
...
class QdrantMediaItems:
    ...
    def __init__(self, synopsis_documents: list[Document]) -> None:
        self._by_id = {doc.metadata["imdb_id"]: _media_item_from_metadata(doc.metadata) for doc in synopsis_documents}
